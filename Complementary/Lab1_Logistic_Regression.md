...
- Overall, lower thresholds favor recall, whereas higher thresholds favor precision.
...
For a fair L1/L2 comparison, the predictors are standardized first because the penalty is applied directly to coefficient size.
